                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="flex gap-2 text-xs">
                    <Link
                      ...
                      className="flex-1 rounded px-2 py-1 text-center text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
                    >
                      Reviews
                    </Link>
                    <Link
                      href={`/dashboard/products/${product.id}/campaigns`}
                      className="flex-1 rounded px-2 py-1 text-center text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
                    >
                      Campaigns
                    </Link>
                    ...
                    <Link
                      href={`/dashboard/products/${product.id}/widget`}
                      className="flex-1 rounded px-2 py-1 text-center text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
                    >
                      Widget
                    </Link>
